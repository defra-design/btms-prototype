...
module.exports = (router) => {
  ...
  registerSummary({
    viewPath: 'mvp/v6/reporting/summary-view',
    getPath:  '/mvp/v6/reporting/summary-view',
    postPath: '/mvp/v6/reporting/summary-view'
  });

  registerSummary({
    viewPath: 'mvp/v6/reporting/summary-view-v2',
    getPath:  '/mvp/v6/reporting/summary-view-v2',
    postPath: '/mvp/v6/reporting/summary-view-v2'
  });

  // ----------------- table routes -----------------
  router.get('/mvp/v6/reporting/no-matches', (req, res) => {
    ...
    res.render('mvp/v6/reporting/no-matches', {
      rows,
      total,
      pagination: {
        page,
  ...
  router.get('/mvp/v6/reporting/no-matches-basic', (req, res) => {
    ...
    res.render('mvp/v6/reporting/no-matches-basic', {
      rows,
      total,
      pagination,
      pageSize,
  ...
  router.get('/mvp/v6/reporting/no-matches-basic.csv', (req, res) => {
  ...
  // ----------------- CSV: Manual releases -----------------
  router.get('/mvp/v6/reporting/manual-release.csv', (req, res) => {
  ...
  router.get('/mvp/v6/search-results', (req, res) => {
    ...
    res.render('mvp/v6/search-results', {
  ...
  router.get('/mvp/v6/reporting/chart-data.json', (req, res) => {
